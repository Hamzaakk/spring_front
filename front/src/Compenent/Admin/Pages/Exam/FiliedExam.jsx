...
import img from "../../../../assets/images/file-folder-document-paper-ui-icon-sign-symbol-3d-rendering.jpg"
            ...
            <div className="h-full w-full">
              ...
              <div className="flex items-center justify-between md:items-center lg:justify-between">
                <Link
                  ...
                  to={`/exams/departement/${params.id}/${filed.id}`}
                >
                  <svg
